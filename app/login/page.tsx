    ...
    <div className="flex flex-1 items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold tracking-tight">Skillosophy</h1>
          <p className="mt-1 text-sm text-muted">
            Career &amp; credential intelligence
          </p>
        </div>

        <div className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
          {appMode === "live" ? <LoginForm /> : <DemoLogin />}
        </div>
...
function DemoLogin() {
  return (
    <div className="space-y-3">
      <p className="text-sm text-muted">Choose a role to explore the prototype:</p>
      <form action={demoLogin.bind(null, "org_admin")}>
        <button
          type="submit"
      ...
      <form action={demoLogin.bind(null, "member")}>
        <button
          type="submit"
      ...
      <form action={demoLogin.bind(null, "platform")}>
        <button
          type="submit"
          className="w-full rounded-lg border border-border py-2.5 text-sm font-semibold transition hover:bg-foundational-soft"
        >
